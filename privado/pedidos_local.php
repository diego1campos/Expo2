											...
											//if ( $data_pedidos != null ){
												foreach($data_pedidos as $datos){
													$pedidos .= "<tr>";
														...
														$pedidos .= '<td class="text-center"><button type="submit" name="id_pedido_local" value="' . $datos['id_pedido_local'] . '" class="nobtn-trans"><a class="icono_tamano glyphicon padding_right_nojs glyphicon-check"></a></button><a href="detalle_pedido-local?id='.base64_encode($datos['id_pedido_local']).'" class="icono_tamano glyphicon glyphicon-eye-open"></a></td>';
													$pedidos .= "</tr>";
												}
												print($pedidos);
											/*}
