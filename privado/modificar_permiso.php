<?php
  ...
  ob_start();
  $permisos = Page::header("Modificar permiso", "tipos_usuarios" );
  $id = null;
    if(!empty($_GET['id_tipo_usuario'])) {
        $id = base64_decode($_GET['id_tipo_usuario']);
    }
    if ( ! Validator::numero( $id ) || $id == null || ! Validator::permiso_modificar( $permisos ) ){
  ...
  if ( !empty($_POST) ) {
    ...
    @$id_tipo_usuario=$_POST['id_tipo_usuario'];//id
    ...
    if (Validator::numeros_letras( $Nombre_permiso )){
        ...
        if ( $suma_calificacion <= 7 &&  $suma_categorias  <= 7 &&  $suma_clientes  <= 7 &&  $suma_comentariosP  <= 7 &&  $suma_contactoE  <= 7 &&  $suma_datos  <= 7 &&  $suma_detalleP  <= 7 && 
              ...
              $suma_preguntas  <= 7 &&  $suma_preguntasF  <= 7 &&  $suma_presentaciones  <= 7 &&  $suma_productos  <= 7 &&  $suma_redes  <= 7 &&  $suma_terminosC  <= 7 &&  $suma_tiposC  <= 7 &&  $suma_tipoU  <= 7 &&  $suma_valores <= 7 && $suma_backup <= 7 )  { 
              ...
              if ( ! Validator::permiso_modificar( $permisos ) ) {
                ...
                //$actual_tipo_usuario = Database::getRow( "select tipo_usuario from tipos_usuarios where id_tipo_usuario" );
                    $sql = "Update tipos_usuarios set tipo_usuario=?,  calificacion_productos=?,  categorias=?,  clientes=?,  comentarios_productos=?,  contactos_empresa=?,  datos=?,  
                              ...
                              tipos_contactos=?,  tipos_usuarios=?,  valores=?,  backup=? where id_tipo_usuario = ?";
                    ...
                    $suma_preguntas,$suma_preguntasF,$suma_presentaciones,$suma_productos,$suma_redes, $suma_terminosC, $suma_tiposC, $suma_tipoU, $suma_valores,$suma_backup,$id_tipo_usuario));
                    $PDO = null;
                    //print( "<a>".$suma_tipoU."</a>" );
                    Database::executeRow( "call inserta_bitacora( ?, ?, ?, ? );" , array ( $_SESSION['id_empleado'],  19, 2, $sql ) );
                    header("location: ver_permisos");
                }
        }  
          ...
          <div class="box-body">
            <div class="row">
              <div class="col-xs-6">
                ...
                <input type="hidden" value="<?php print($id); ?>" id="id_tipo_usuario" name="id_tipo_usuario">
                <input id="txtNombreTU" name="Nombre_permiso" type="text" autocomplete="off" class="form-control <?php print( ( isset($er_nombre) ) ? "$er_nombre": ""); ?>" placeholder=" ...">
    ...
    <div class="row">
      <div class="well well-sm col-md-9 col-lg-11 ">
            ...
            <div class="btn-group col-md-6  col-lg-3" data-toggle="buttons">
              ...
              <label  class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input class="access_check" type="checkbox" autocomplete="off"  id="agregar_calificacionp" value="4" name="calificacion_productos[]">
            ...
            <div class="btn-group col-md-6  col-lg-3" data-toggle="buttons">
              <h5>Categorias</h5>
              <label  class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input class="access_check" type="checkbox" autocomplete="off"  id="agregar_categorias" value="4" name="categorias[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6  col-lg-3" data-toggle="buttons">
              <h5>Clientes</h5>
              <label  class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input class="access_check" type="checkbox" autocomplete="off"  id="agregar_cliente" value="4" name="clientes[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6  col-lg-3" data-toggle="buttons">
              ...
              <label  class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input class="access_check" type="checkbox" autocomplete="off"  id="agregar_comentariop" value="4" name="comentarios_productos[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label  class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input class="access_check" type="checkbox" autocomplete="off"  id="agregar_contactoe" value="4" name="contactos_empresa[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Datos</h5>
              <label  class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input class="access_check" type="checkbox" autocomplete="off"  id="agregar_datos" value="4" name="datos[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label  class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input class="access_check" type="checkbox" autocomplete="off"  id="agregar_detallep" value="4" name="detalles_pedidos[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label  class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input class="access_check" type="checkbox" autocomplete="off"  id="agregar_detallep" value="4" name="detalles_pedidos_local[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Direcciones</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_direcciones"  value="4" name="direcciones[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Empleados</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_empleados" value="4" name="empleados[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_entregarp" value="4" name="entregar_pedidos[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
           ...
           <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Existencias</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_existencias" value="4" name="existencias[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_horarios" value="4" name="horarios_entrega[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_imagenesI" value="4" name="index_imagenes[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_imagenesp" value="4" name="img_productos[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Pedidos</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_pedidos" value="4" name="pedidos[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Pedidos local</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_pedidosl" value="4" name="pedidos_local[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Preguntas</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_preguntas" value="4" name="preguntas[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_preguntasf"value="4" name="preguntas_frecuentes[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_presentaciones" value="4" name="presentaciones[]">  
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Productos</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_productos" value="4" name="productos[]">  
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_redes" value="4" name="redes_sociales[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off" id="agregar_terminos"  value="4" name="terminos_condiciones[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
           ...
           <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_tiposc" value="4" name="tipos_contactos[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              ...
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_tipoU" value="4" name="tipos_usuarios[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
             ...
             <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Valores</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de Insertar!">
                <input type="checkbox" autocomplete="off"  id="agregar_valores" value="4" name="valores[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
            ...
            <div class="btn-group col-md-6 col-lg-3 " data-toggle="buttons">
              <h5>Backup</h5>
              <label class="btn btn-info btnUsuario  " data-toggle="tooltip" data-placement="top" title="¡Permiso de exportar!">
                <input type="checkbox" autocomplete="off"  value="4" name="backup[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
              ...
              <label class="btn btn-danger btnUsuario " data-toggle="tooltip" data-placement="top" title="¡Permiso de eliminar!">
                <input type="checkbox" autocomplete="off"  value="1" name="backup[]">
                <span class="glyphicon glyphicon-ok"></span>
              </label>
      ...
      <button id="guardar_permiso"> Modificar</button>
    </form>    
