...
//Se establece todas las clases o funciones necesarias ='D'
	...
	//Se llama a la funcion header que pone todos los css y para todos los .php de publico ='}
  	$permisos = Page::header("Maximo dia", "datos");
  if(!empty($_POST)){
  	try{
	    $action = $_POST['action'];
	    if ( $action != "Buscar" ){
		    ...
		    $PDO->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		   	...
		   	if (Validator::numero( $max_dias ) ){
			  	...
			  	else
			  	{
				        ...
				        $sql = "UPDATE datos set max_dias_pedido=? where id_dato=?";
   ...
   $palabra = '';
	...
	print ( ( isset($exito) && $exito == 1 ) ? '<div class="alert alert-success" role="alert">Maximo dia '.$palabra.' con exito.</div>' : "" );
						...
						<div class="box-body table-responsive">
							<div class="col-sm-12 col-md-12 col-lg-12">
								<table class="table table-bordered table-hover conf_tabla">
								    <thead>
								        <tr>
								            <th class="col-sm-3 col-md-3 col-lg-3">Maximo dia</th>
								    ...
								    <?php
									    ...
									    $tabla.="</div>";
									    $tabla.="<td><div class='pro_min'>$datos[max_dias_pedido]</div></td>";
									    $tabla.="<td> ";
